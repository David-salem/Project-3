      ...
      .then(function(data) {
        ...
        let result = "";
            ...
            function myFunction(value) {
                result += `<li><a href="/company.html?symbol=${value.symbol}" class="text-decoration-none font-weight-normal text-secondary fs-4 hover-overlay">${value.name} (${value.symbol})</a></li>`
            }
      });  
});
